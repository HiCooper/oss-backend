...
public class ReedSolomon {
    ...
    public static ReedSolomon create(int dataShardCount, int parityShardCount) {
        return new ReedSolomon(dataShardCount, parityShardCount, new OutputInputByteTableAbstractCodingLoop());
    }
